...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 w-full">
            <div className="max-w-4xl">
              ...
              <motion.h1
                ...
                className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-medium leading-[0.95] sm:leading-[0.9] text-white mb-6 sm:mb-8"
              >
                Drift Into
                <br />
